...
import (
	"github.com/JenniO/bookstore_oauth-api/src/clients/cassandra"
...
func (r *dbRepository) GetById(userId string) (*access_token.AccessToken, *errors.RestErr) {
	var result access_token.AccessToken
	if err := cassandra.GetSession().Query(queryGetAccessToken, userId).Scan(
