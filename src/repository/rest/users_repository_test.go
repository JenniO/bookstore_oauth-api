...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "4", "first_name": "Edith","last_name": "Ozolins","email": "e@c.de","date_created": "2020-10-21 11:24:56","status": "active"}`,
	})
	repository := usersRepository{}
...
func TestLoginUserNoErr(t *testing.T) {
	...
	assert.EqualValues(t, "Edith", user.FirstName)
	assert.EqualValues(t, "Ozolins", user.LastName)
	assert.EqualValues(t, "e@c.de", user.Email)
}
